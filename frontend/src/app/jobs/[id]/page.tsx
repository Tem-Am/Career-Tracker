...
export default function JobDetailPage() {
  ...
  const fetchResume = useCallback(async () => {
    ...
    try {
      ...
      setResumeError(err instanceof ApiError ? err.message : 'Failed to load resume');
    } finally {
  ...
  async function saveResume() {
    ...
    try {
      ...
      setResumeError(err instanceof ApiError ? err.message : 'Failed to save resume');
    } finally {
  ...
  return (
    <>
      ...
      <div style={{ fontFamily: "'Instrument Sans', sans-serif", background: '#faf9f7', minHeight: '100vh', color: '#1a1916' }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              fontSize: '11px', color: '#8a8474', cursor: 'pointer',
          ...
          <span style={{ fontSize: '12px', color: '#8a8474', fontFamily: "'DM Mono', monospace" }}>
        ...
        <div style={{
          ...
          {/* ════════════════ LEFT / MAIN ════════════════ */}
          <div style={{ padding: '40px 44px 60px 40px', borderRight: '1px solid #e8e4dc' }}>
            ...
            {job ? (
              <div>
                ...
                <div style={{
                  ...
                  color: '#b8820a', background: 'rgba(184,130,10,0.08)',
                  border: '1px solid rgba(184,130,10,0.22)',
                  borderRadius: '2px', padding: '3px 10px',
                  letterSpacing: '0.12em', textTransform: 'uppercase',
                  marginBottom: '14px',
                }}>
                  <span style={{ width: 5, height: 5, borderRadius: '50%', background: '#b8820a', display: 'inline-block' }} />
                  {job.status}
                </div>

                <h1 style={{
                  fontFamily: "'Playfair Display', serif",
                  fontSize: '30px', fontWeight: 600, lineHeight: 1.2,
                  color: '#1a1916', margin: '0 0 8px', letterSpacing: '-0.02em',
                }}>
                  {job.title}
                </h1>
                <p style={{ fontSize: '13px', color: '#8a8474', fontFamily: "'DM Mono', monospace", margin: 0 }}>
                  {job.company}
                </p>
                ...
                <p style={{
                  ...
                  color: '#b8b2a4', fontWeight: 600, marginBottom: '12px',
                }}>
                  Job Description
                </p>
                <div style={{
                  ...
                  <p style={{ fontSize: '13px', lineHeight: 1.75, color: '#5a5650', whiteSpace: 'pre-wrap', margin: 0 }}>
                    {job.description}
                  </p>
                </div>
              </div>
            ...
            <div style={{ marginTop: '40px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                <h2 style={{
                  fontFamily: "'Playfair Display', serif",
                  fontSize: '20px', fontWeight: 600, color: '#1a1916', margin: 0,
                }}>
                  AI Match Analysis
                </h2>
                {latest && (
                  <span style={{
                    fontSize: '10px', fontFamily: "'DM Mono', monospace",
                    color: '#5a9e7a', background: 'rgba(90,158,122,0.1)',
              ...
              {matchLoading && (
                <div style={{
                  ...
                  <span style={{
                    width: 8, height: 8, borderRadius: '50%', background: '#b8820a',
                    display: 'inline-block', animation: 'pulse-dot 1.2s ease-in-out infinite',
                  }} />
                  <span style={{ fontSize: '13px', color: '#8a8474', fontFamily: "'DM Mono', monospace" }}>
              ...
              {latest && !matchLoading && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                  ...
                  <div style={{
                    ...
                    borderRadius: '6px', padding: '22px 28px',
                    display: 'flex', alignItems: 'flex-end', gap: '16px',
                    position: 'relative', overflow: 'hidden',
                  }}>
                    <div style={{
                      position: 'absolute', left: 0, top: 0, bottom: 0,
                      width: '3px', background: '#b8820a',
                    }} />
                    <span style={{
                      fontFamily: "'Playfair Display', serif",
                      fontSize: '54px', fontWeight: 600, lineHeight: 1,
                      color: '#b8820a', letterSpacing: '-0.03em',
                    }}>
                      {latest.result.matchScore}
                      <span style={{ fontSize: '24px', color: '#d4a84b' }}>%</span>
                    </span>
                    <div style={{ paddingBottom: '6px' }}>
                      <p style={{
                        fontSize: '11px', color: '#8a8474', letterSpacing: '0.1em',
                        textTransform: 'uppercase', fontFamily: "'DM Mono', monospace", margin: 0,
                      }}>
                        Match Score
                      </p>
                    </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                    ...
                    <div style={{
                      background: '#fff', border: '1px solid #e8e4dc',
                      borderTop: '2px solid #5a9e7a', borderRadius: '6px', padding: '16px',
                    }}>
                      <p style={{
                        fontSize: '10px', letterSpacing: '0.12em', textTransform: 'uppercase',
                        color: '#5a9e7a', fontWeight: 600, margin: '0 0 12px',
                      }}>
                        Strong Matches
                      </p>
                    ...
                    <div style={{
                      background: '#fff', border: '1px solid #e8e4dc',
                      borderTop: '2px solid #c96b6b', borderRadius: '6px', padding: '16px',
                    }}>
                      <p style={{
                        fontSize: '10px', letterSpacing: '0.12em', textTransform: 'uppercase',
                        color: '#c96b6b', fontWeight: 600, margin: '0 0 12px',
                      }}>
                        Missing Skills
                      </p>
                      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
              ...
              {!latest && !matchLoading && (
                <div style={{
                  background: '#fff', border: '1px dashed #d8d4cc',
                  borderRadius: '6px', padding: '48px 24px',
                  textAlign: 'center', color: '#b8b2a4', fontSize: '13px',
                }}>
              ...
              {error && (
                <p style={{ fontSize: '12px', color: '#c96b6b', marginTop: '10px', fontFamily: "'DM Mono', monospace" }}>
                  {error}
                </p>
              )}
            </div>
          ...
          <div style={{ padding: '40px 32px 60px' }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                <h2 style={{
                  fontFamily: "'Playfair Display', serif",
                  fontSize: '17px', fontWeight: 600, color: '#1a1916', margin: 0,
                }}>
                  Your Resume
                </h2>
                <span style={{ fontSize: '11px', fontFamily: "'DM Mono', monospace", color: '#b8b2a4' }}>
              ...
              {resumeLoading ? (
                <div style={{
                  height: '220px', background: '#f4f2ee',
                  border: '1px solid #e8e4dc', borderRadius: '4px',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                }}>
                  <span style={{ fontSize: '12px', color: '#b8b2a4', fontFamily: "'DM Mono', monospace" }}>
                    Loading...
                  </span>
                </div>
              ) : (
              ...
              <button
                ...
                style={{
                  ...
                  background: 'transparent', border: '1px solid #d0cbc0',
                  borderRadius: '4px', color: '#8a8474',
                  fontSize: '12px', fontFamily: "'Instrument Sans', sans-serif",
                  fontWeight: 500, letterSpacing: '0.06em',
                  cursor: resumeSaving || !resumeText.trim() ? 'not-allowed' : 'pointer',
              ...
              {resumeNotice && (
                <p style={{ fontSize: '11px', fontFamily: "'DM Mono', monospace", color: '#5a9e7a', margin: '8px 0 0' }}>
                  {resumeNotice}
                </p>
              )}
              {resumeError && (
                <p style={{ fontSize: '11px', fontFamily: "'DM Mono', monospace", color: '#c96b6b', margin: '8px 0 0' }}>
                  {resumeError}
                </p>
              )}
            </div>
            ...
            <div style={{
              ...
              <div style={{ padding: '20px 20px 18px', borderBottom: '1px solid #e8e4dc' }}>
                <p style={{
                  fontSize: '10px', letterSpacing: '0.15em', textTransform: 'uppercase',
                ...
                <h3 style={{
                  fontFamily: "'Playfair Display', serif",
                  fontSize: '20px', fontWeight: 600, color: '#1a1916', margin: '0 0 6px',
                }}>
                  Run Match
                </h3>
                <p style={{ fontSize: '12px', color: '#8a8474', lineHeight: 1.6, margin: 0 }}>
                  Compare your resume against this job using Claude AI. Takes ~10 seconds.
                </p>
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  background: matchLoading || !resumeText.trim() || !job ? '#e8c87a' : '#b8820a',
                  border: 'none', color: '#fff',
                  fontSize: '12px', fontFamily: "'Instrument Sans', sans-serif",
                  fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase',
                  cursor: matchLoading || !resumeText.trim() || !job ? 'not-allowed' : 'pointer',
            ...
            {insights.length > 1 && (
              <div style={{ marginTop: '20px' }}>
                <p style={{
                  fontSize: '10px', letterSpacing: '0.12em', textTransform: 'uppercase',
                  color: '#b8b2a4', fontWeight: 600, margin: '0 0 10px',
                  fontFamily: "'DM Mono', monospace",
                }}>
                  Previous Runs
                </p>
