...
> = {
  saved: {
    color: "#7b8fdc",
    bg: "rgba(123,143,220,0.08)",
    border: "rgba(123,143,220,0.22)",
    bar: "#7b8fdc",
  },
  applied: {
    color: "#b8820a",
    bg: "rgba(184,130,10,0.08)",
    border: "rgba(184,130,10,0.22)",
    bar: "#b8820a",
  },
  interview: {
    color: "#5a9e7a",
    bg: "rgba(90,158,122,0.08)",
    border: "rgba(90,158,122,0.22)",
    bar: "#5a9e7a",
  },
  offer: {
    color: "#5a9e7a",
...
const DEFAULT_ACCENT = {
  color: "#8a8474",
  bg: "rgba(138,132,116,0.08)",
  border: "rgba(138,132,116,0.22)",
  bar: "#b8b2a4",
};
              ...
              {job.visa && (
                <span
                  style={{
                    ...
                    border: `1px solid ${job.visa === "yes" ? "rgba(90,158,122,0.3)" : "rgba(201,107,107,0.3)"}`,
                    borderRadius: "2px",
          ...
          <div style={{ flex: 1 }}>
            <p
              style={{
                ...
                minHeight: "59px", // ← locks height for 3 lines regardless of content
              }}
            >
