...
export default function JobFormModal({
  ...
  const [form, setForm] = useState({
    ...
    visa: existingJob?.visa ?? (null as string | null),
  });
            ...
            {SECTIONS.map((s) => (
              <button
                ...
                style={{
                  ...
                  borderBottomColor:
                    section === s.id ? "#b8820a" : "transparent",
                  fontSize: "12px",
            ...
            <div style={{ padding: "24px", flex: 1 }}>
              ...
              {section === "basic" && (
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Answer for Requires Sponsorship?
                      <span
                        style={{
                          marginLeft: "6px",
                          fontSize: "9px",
              ...
              {section === "description" && (
                <div>
                  ...
                  >
                    Adding a description enables AI match scoring against your
                    resume.
                  </p>
                </div>
              )}
