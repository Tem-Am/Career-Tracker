  ...
  interface JobFormModalProps {
    ...
    onClose: () => void;
    prefillDescription?: string; // optional: pre-fill from Analyze modal
  }
  ...
  export default function JobFormModal({ existingJob, onSubmit, onClose, prefillDescription }: JobFormModalProps) {
    ...
    const [form, setForm] = useState({
      ...
      description: existingJob?.description ?? prefillDescription ?? "",
    });
    ...
    const validate = () => {
      ...
      // description and source are now optional — no validation
      setErrors(errs);
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      onSubmit({
        ...
        description: form.description.trim() || undefined, // null when empty
      });
    };
          ...
          >
            ...
            <div style={{
              ...
              <button
                ...
                onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#c96b6b"; e.currentTarget.style.color = "#c96b6b"; }}
                onMouseLeave={(e) => { e.currentTarget.style.borderColor = "#e8e4dc"; e.currentTarget.style.color = "#b8b2a4"; }}
              >
                <X size={14} />
              </button>
            </div>
              ...
              <div style={{ padding: "24px", flex: 1 }}>
                      ...
                      <div>
                        ...
                        <div style={{ position: "relative" }}>
                          <select
                            ...
                            className="jf-select"
                            style={{ ...inputStyle("status"), appearance: "none", paddingRight: "32px", cursor: "pointer" }}
                          >
                            {STATUS_ORDER.map((s) => (
                      ...
                      <div>
                        <label style={{
                          ...
                          <span style={{
                            ...
                            color: "#b8b2a4", letterSpacing: "0.06em", textTransform: "none",
                          }}>
                            optional
                          </span>
                        </label>
                ...
                {section === "description" && (
                  <div>
                    ...
                    />
                    <p style={{
                      fontSize: "11px", color: "#b8b2a4", margin: "6px 0 0",
                      fontFamily: "'DM Mono', monospace",
                    }}>
                      Adding a description enables AI match scoring against your resume.
                    </p>
                  </div>
                )}
              </div>
                  ...
                  {section === "basic" ? (
                    ...
                    <>
                      <button
                        ...
                        onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#d0cbc0"; e.currentTarget.style.color = "#1a1916"; }}
                        onMouseLeave={(e) => { e.currentTarget.style.borderColor = "#e8e4dc"; e.currentTarget.style.color = "#8a8474"; }}
                      >
                        Back
                      </button>
                      <button
